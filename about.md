...
[![Build](https://github.com/karnpapon/pdqb/actions/workflows/run.yml/badge.svg)](https://github.com/karnpapon/pdqb/actions/workflows/run.yml)

**pdqb** (probabilistic-determinism's-quirk-based procedures) is a fully automated procedures. to explore, critic, thought-provoking underlying layers of large language model, and so-called Artificial Intelligence in general, reflect in digital form.
