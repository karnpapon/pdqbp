```json
"2023-02-23":{"data":["a woman in a black dress standing next to a mirror "],"duration":4.4540956020355225,"average_duration":11.045599886665144}
```
```json
...
```
```json
"2023-03-06":{"data":["a crowd of people standing around a large group of people "],"duration":5.207799673080444,"average_duration":5.520513468600334}
```
```json
"2023-03-07":{"data":["a crowd of people standing around a crowd of people "],"duration":10.221726655960083,"average_duration":16.2154255130984}
```
```json
...
```
```json
"2023-03-12":{"data":["a man is fixing a pipe on a wall "],"duration":5.678689241409302,"average_duration":6.616457512680913}
```
```json
...
```
```json
"2023-03-18":{"data":["a house with a large window and a small building "],"duration":8.910776376724243,"average_duration":6.854453844961777}
```
```json
...
```
```json
"2023-03-23":{"data":["a bird perched on a branch with a tree "],"duration":2.0726325511932373,"average_duration":3.4652992784092618}
```
```json
"2023-03-24":{"data":["two birds perched on a branch in a tree "],"duration":1.5223071575164795,"average_duration":3.1720176579603647}
```
```json
"2023-03-25":{"data":["birds perched on a tree branch "],"duration":1.3612475395202637,"average_duration":2.9467003023234715}
```
```json
"2023-03-26":{"data":["birds perched on top of a tree "],"duration":1.4799623489379883,"average_duration":2.8244388917715346}
```
```json
"2023-03-27":{"data":["birds perched on a tree branch "],"duration":1.4686319828033447,"average_duration":2.8614393685352595}
```
```json
"2023-03-28":{"data":["a painting of birds on a tree "],"duration":1.6712684631347656,"average_duration":2.8828126759914303}
```
```json
...
```
```json
"2023-04-03":{"data":["a group of people standing together in a room "],"duration":1.4133291244506836,"average_duration":3.4971726617639747}
```
```json
"2023-04-04":{"data":["a collage of photos of people in a park "],"duration":1.8481218814849854,"average_duration":3.4338364986229872}
```
```json
"2023-04-05":{"data":["a collage of photos of people in a park "],"duration":1.9667770862579346,"average_duration":3.43898970893033}
```
```json
"2023-04-06":{"data":["a collage of photos of people and animals "],"duration":2.076085090637207,"average_duration":18.64594996043099}
```
```json
...
```
```json
"2023-04-09":{"data":["a collage of photos of people in a variety of poses "],"duration":31.467409372329712,"average_duration":12.477760095797606}
```
```json
"2023-04-10":{"data":["a collage of photos of people in a room "],"duration":2.146709442138672,"average_duration":9.98747922414561}
```
```json
"2023-04-11":{"data":["a collage of photos of people and their belongings "],"duration":1.955420970916748,"average_duration":8.773477273914473}
```
```json
"2023-04-12":{"data":["a collage of photos of people in a room "],"duration":2.753047466278076,"average_duration":8.369761900170063}
```
```json
...
```
```json
"2023-04-17":{"data":["a bird perched on a tree branch "],"duration":1.7518305778503418,"average_duration":7.426940542745689}
```
```json
"2023-04-18":{"data":["a bird perched on a branch in a tree "],"duration":8.297446250915527,"average_duration":7.312656878661894}
```
```json
"2023-04-19":{"data":["a bird is perched on a branch in a tree "],"duration":1.757389783859253,"average_duration":7.120424430229758}
```
```json
"2023-04-20":{"data":["a bird perched on a branch in a tree "],"duration":1.7206811904907227,"average_duration":7.030604748287703}
```
```json
...
```
```json
"2023-04-30":{"data":["three girls posing for a picture in the snow "],"duration":2.3897953033447266,"average_duration":3.4732106260278006}
```
```json
...
```
```json
"2023-05-09":{"data":["a snowboarder is jumping over a snow covered slope "],"duration":2.4081335067749023,"average_duration":6.791255676124191}
```
```json
...
```
```json
"2023-05-12":{"data":["a snowboarder is jumping over a snow covered slope "],"duration":2.0337471961975098,"average_duration":5.720266331133178}
```
```json
"2023-05-13":{"data":["a snowboarder is doing a trick on a snowboard "],"duration":2.9038589000701904,"average_duration":5.373101142718485}
```
```json
...
```
```json
"2023-05-27":{"data":["a man and a woman sitting at a table with a laptop "],"duration":3.563232660293579,"average_duration":3.9214193249759055}
```
```json
"2023-05-28":{"data":["people sitting around a table with laptops "],"duration":0.98923659324646,"average_duration":3.449592541755603}
```
```json
"2023-05-29":{"data":["people sitting around a table with laptops "],"duration":1.1940357685089111,"average_duration":3.8652911505647696}
```
```json
"2023-05-30":{"data":["a room filled with people sitting around a table "],"duration":14.871155500411987,"average_duration":4.590830135054326}
```
```json
"2023-05-31":{"data":["a large group of people sitting around a table "],"duration":4.096848726272583,"average_duration":4.550598701474923}
```
```json
"2023-06-01":{"data":["a large group of people sitting around a table "],"duration":2.3632357120513916,"average_duration":4.315661735907075}
```
```json
"2023-06-02":{"data":["a large group of people sitting around a table "],"duration":1.1619632244110107,"average_duration":4.240369925903309}
```
```json
...
```
```json
"2023-06-05":{"data":["a large group of people sitting around a table "],"duration":1.5111775398254395,"average_duration":3.755353507617887}
```
```json
"2023-06-06":{"data":["a large group of people sitting around a table "],"duration":14.673675298690796,"average_duration":3.8116635423776777}
```
```json
"2023-06-07":{"data":["a large group of people sitting around a table "],"duration":3.473985433578491,"average_duration":3.8510925161157474}
```
```json
"2023-06-08":{"data":["a crowd of people standing around a building "],"duration":1.4546372890472412,"average_duration":3.8437585209938114}
```
```json
"2023-06-09":{"data":["a large group of people standing in front of a building "],"duration":18.4433114528656,"average_duration":3.83771151631285}
```
```json
...
```
```json
"2023-06-13":{"data":["a crowd of people standing around a building "],"duration":1.1094639301300049,"average_duration":1.9230472471631577}
```
```json
...
```
```json
"2023-06-23":{"data":["horses standing in a field "],"duration":1.4189708232879639,"average_duration":2.0435406417978537}
```
```json
"2023-06-24":{"data":["a herd of horses standing in a field "],"duration":1.9017069339752197,"average_duration":2.038058908599416}
```
```json
"2023-06-25":{"data":["a herd of horses standing on top of a lush green field "],"duration":2.55074143409729,"average_duration":2.0978682476744583}
```
```json
"2023-06-26":{"data":["a herd of horses grazing on a lush green field "],"duration":1.4431061744689941,"average_duration":2.0970875303663226}
```
```json
...
```
```json
"2023-06-29":{"data":["horses are running in a field "],"duration":1.7286522388458252,"average_duration":2.2442544615757734}
```
```json
...
```
```json
"2023-07-04":{"data":["a crowd of people walking down a hill "],"duration":1.1386971473693848,"average_duration":2.184043076572073}
```
```json
"2023-07-05":{"data":["a crowd of people walking down a dirt road "],"duration":1.942486047744751,"average_duration":2.1927147845373116}
```
```json
"2023-07-06":{"data":["people are riding horses down a dirt road "],"duration":1.2439422607421875,"average_duration":2.18975682429534}
```
```json
"2023-07-07":{"data":["a line of horses walking down a dirt road "],"duration":1.9644179344177246,"average_duration":2.1945535830652663}
```
```json
"2023-07-08":{"data":["a herd of horses walking down a dirt road "],"duration":1.264798879623413,"average_duration":2.188660581039882}
```
```json
...
```
```json
"2023-07-11":{"data":["a herd of horses running down a dirt road "],"duration":1.2962403297424316,"average_duration":2.25890481878431}
```
```json
"2023-07-12":{"data":["a herd of horses running along a dirt road "],"duration":2.104243516921997,"average_duration":2.260694470056212}
```
```json
...
```
```json
"2023-07-15":{"data":["a large group of people riding horses down a dirt road "],"duration":2.393198013305664,"average_duration":2.262468480898498}
```
```json
"2023-07-16":{"data":["a large group of people riding horses down a dirt road "],"duration":2.2683043479919434,"average_duration":2.262616620645341}
```
```json
...
```
```json
"2023-07-19":{"data":["people are riding horses down a dirt road "],"duration":1.8623645305633545,"average_duration":2.2638677055578436}
```
```json
"2023-07-20":{"data":["a line of horses running down a dirt road "],"duration":2.060814619064331,"average_duration":2.2675109604296577}
```
```json
"2023-07-21":{"data":["a herd of horses running down a dirt road "],"duration":2.075080633163452,"average_duration":2.274831804256735}
```
```json
"2023-07-22":{"data":["a line of horses running down a dirt road "],"duration":2.062105894088745,"average_duration":2.28410234850158}
```
```json
"2023-07-23":{"data":["a herd of horses running across a dirt road "],"duration":2.1647720336914062,"average_duration":2.2925260590785177}
```
```json
"2023-07-24":{"data":["a herd of horses running down a dirt road "],"duration":1.3514106273651123,"average_duration":2.334632147561802}
```
```json
"2023-07-25":{"data":["a herd of horses walking down a dirt road "],"duration":2.031344413757324,"average_duration":2.3647893745835775}
```
```json
"2023-07-26":{"data":["a line of horses walking down a dirt road "],"duration":2.1125285625457764,"average_duration":2.364038852392831}
```
```json
"2023-07-27":{"data":["a herd of horses running down a dirt road "],"duration":1.9988188743591309,"average_duration":2.3639026674721313}
```
```json
"2023-07-28":{"data":["a large group of people riding horses on a dirt road "],"duration":2.3498806953430176,"average_duration":2.363369535433618}
```
```json
"2023-07-29":{"data":["a line of horses running down a dirt road "],"duration":2.077944040298462,"average_duration":2.363184833168878}
```
```json
...
```
```json
"2023-08-10":{"data":["cows are grazing in a field "],"duration":1.7592346668243408,"average_duration":2.3886542582338675}
```
```json
...
```
```json
"2023-10-15":{"data":["a wall with graffiti on it with graffiti on it "],"duration":63.84068703651428,"average_duration":106.18186246916012}
```
